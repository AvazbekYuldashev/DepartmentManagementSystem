...
public interface EmployeeRepository extends JpaRepository<EmployeeEntity, Integer> {
    ...
    int updateStatus(@Param("idP") Integer id, @Param("statusP") GeneralStatus status, @Param("updatedDateP") LocalDateTime updatedDateP);
    ...
    @Transactional
    @Modifying
    @Query("UPDATE EmployeeEntity e SET e.status = :status WHERE e.id = :id")
